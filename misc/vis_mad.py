...
def main(args):
    ...
    for d in data:
        ...
        Round0_InputPrompt.append(d['input'].get('Agent 1_Round0_input_prompt', ""))
        Round0_Output.append(d['output'].get('Agent 1_Round0_output', ""))
        Round1_InputPrompt.append(d['input'].get('Agent 1_Round1_input_prompt', ""))
        Round1_Output.append(d['output'].get('Agent 1_Round1_output', ""))
        Round2_InputPrompt.append(d['input'].get('Agent 1_Round2_input_prompt', ""))
        Round2_Output.append(d['output'].get('Agent 1_Round2_output', ""))
        
        agent_names.append("Agent 2")
        Round0_InputPrompt.append(d['input'].get('Agent 2_Round0_input_prompt', ""))
        Round0_Output.append(d['output'].get('Agent 2_Round0_output', ""))
        Round1_InputPrompt.append(d['input'].get('Agent 2_Round1_input_prompt', ""))
        Round1_Output.append(d['output'].get('Agent 2_Round1_output', ""))
        Round2_InputPrompt.append(d['input'].get('Agent 2_Round2_input_prompt', ""))
        Round2_Output.append(d['output'].get('Agent 2_Round2_output', ""))
        
        agent_names.append("Moderator")
        Round0_InputPrompt.append(d['input'].get('Moderator_Round0_input_prompt', ""))
        Round0_Output.append(d['output'].get('Moderator_Round0_output', ""))
        Round1_InputPrompt.append(d['input'].get('Moderator_Round1_input_prompt', ""))
        Round1_Output.append(d['output'].get('Moderator_Round1_output', ""))
        Round2_InputPrompt.append(d['input'].get('Moderator_Round2_input_prompt', ""))
        Round2_Output.append(d['output'].get('Moderator_Round2_output', ""))
